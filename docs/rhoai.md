...
3) Access the `workbench` named `audio-to-text-y1731927990785-notebook`.
...
5) In the terminal, run `cd audio-to-text-y1731927990785` to navigate to your sample app's directory.
